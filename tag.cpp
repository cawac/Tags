...
void game::create() {// make the initial tag
    ...
    for (int i = 0; i < 1000000; ++i) {
        ...
        if (key1 != key2)
        {
            switch (key1) {
                case 0:
                    if (place_of_zero_y + 1 != 4){
                        move(table[place_of_zero_y + 1][place_of_zero_x].getNumber());
                        key2 = key1+2;
                    }
                    else
                        i--;
                    break;
                case 1:
                    if (place_of_zero_x + 1 != 4){
                        move(table[place_of_zero_y][place_of_zero_x + 1].getNumber());
                        key2 =key1+2;
                    }
                    else
                        i--;
...
void game::move(int changefield) {
    if ((place_of_zero_x+1)!=n && table[place_of_zero_y][place_of_zero_x+1]==changefield)
    {
    ...
    if ((place_of_zero_x-1)!=-1 && table[place_of_zero_y][place_of_zero_x-1]==changefield)
    {
        this->table[place_of_zero_y][place_of_zero_x].setNumber(changefield);
        this->place_of_zero_x--;
        this->table[place_of_zero_y][place_of_zero_x].setNumber(0);
    ...
    if (place_of_zero_y+1!=n && table[place_of_zero_y+1][place_of_zero_x]==changefield)
    {
        this->table[place_of_zero_y][place_of_zero_x].setNumber(changefield);
    ...
    if (place_of_zero_y-1!=-1 && table[place_of_zero_y-1][place_of_zero_x]==changefield)
    {
        this->table[place_of_zero_y][place_of_zero_x].setNumber(changefield);
        this->place_of_zero_y--;
        this->table[place_of_zero_y][place_of_zero_x].setNumber(0);
